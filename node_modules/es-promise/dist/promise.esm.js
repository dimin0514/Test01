...
if (typeof Promise$2.try !== 'function') {
  Promise$2.try = {
...
if (typeof Promise$2.prototype.finally !== 'function') {
  ...
  var shim = {
      ...
      var C;
      var newPromise = Promise$2.prototype.then.call(this, // throw if IsPromise(this) is not true
      function (x) {
      ...
      C = speciesConstructor(this, Promise$2); // throws if SpeciesConstructor throws
      return newPromise;
    }
  };
  Object.defineProperty(Promise$2.prototype, 'finally', { configurable: true, writable: true, value: shim.finally }); /* eslint no-extend-native: "off" */
}
