...
var isNode = toString.call(process) === '[object process]';
...
var empty = function empty() {};var USE_NATIVE = !!function () {
  try {
...
if (!USE_NATIVE) {
  $Promise = _global.Promise = promise;
}
...
if (typeof Promise$3.try !== 'function') {
  Promise$3.try = {
    try: function _try(func) {
...
if (typeof Promise$3.prototype.finally !== 'function') {
  ...
  var shim = {
      ...
      var C;
      var newPromise = Promise$3.prototype.then.call(this, // throw if IsPromise(this) is not true
      function (x) {
      ...
      C = speciesConstructor(this, Promise$3); // throws if SpeciesConstructor throws
      return newPromise;
    }
  };
  Object.defineProperty(Promise$3.prototype, 'finally', { configurable: true, writable: true, value: shim.finally }); /* eslint no-extend-native: "off" */
}
